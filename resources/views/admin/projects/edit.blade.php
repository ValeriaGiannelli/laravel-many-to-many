...
<div class="container my-5">
    ...
    <form class="row g-3" action="{{route('admin.projects.update', $project)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            ...
            <img src="{{asset('storage/' . $project->img_path)}}" alt="{{ $project->img_original_name }}" onerror="this.src='/img/no_img.jpg'" class="thumb-mini" id="thumb">
        </div>
        ...
        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
            @foreach ($technologies as $technology)
                ...
                <input name="technologies[]" value="{{$technology->id}}" type="checkbox" class="btn-check" id="tech-{{$technology->id}}" autocomplete="off" @if(!$errors->any() && $project->technologies->contains($technology) || $errors->any() && in_array($technology->id, old('technologies', []))) checked @endif>
